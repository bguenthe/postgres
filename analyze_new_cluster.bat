...
echo     "C:/Program Files/PostgreSQL/9.4/bin/vacuumdb" -U "postgres" --all --analyze-only
echo.

"C:/Program Files/PostgreSQL/9.4/bin/vacuumdb" -U "postgres" --all --analyze-in-stages
echo.
